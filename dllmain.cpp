...
#ifdef season541
    CREATEHOOK(uintptr_t(GetModuleHandle(0)) + 0x12FF630, UnsafeEnvironment, nullptr);
    CREATEHOOK(uintptr_t(GetModuleHandle(0)) + 0x168B950, RequestExit, nullptr);
#endif

    MH_EnableHook(MH_ALL_HOOKS);

    std::cout << "Successfully bypassed UnsafeEnvironment and RequestExit.";
